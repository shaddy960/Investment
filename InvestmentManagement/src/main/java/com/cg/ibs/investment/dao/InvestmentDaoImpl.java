...
public class InvestmentDaoImpl implements BankDao, CustomerDao {
	...
	private static HashMap<String, InvestmentBean> investmentBeans1 = new HashMap<>();
	...
	static {
		...
		investmentBeans1.put("Bank", bank);
	...
	public InvestmentBean viewDetails(String userId) {
		return investmentBeans1.get(userId);
	}
